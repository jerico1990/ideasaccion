...
<button class="btn btn-raised btn-default" type="button" id="btnprimeraentrega" <?= (!$etapa1 || $equipo->etapa==1)?'disabled':'' ?>>Cerrar primera entrega</button>
<?php }?>
<?php if($etapa2 && $equipo->etapa==1){ ?>
<button class="btn btn-raised btn-default" type="button" id="btnsegundaentrega" <?= (!$etapa2 || $equipo->etapa==2)?'disabled':'' ?>>Cerrar segunda entrega</button>
<?php }?>
