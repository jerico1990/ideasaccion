...
<div ng-app="ideasaccion" class="box_content contenido_seccion_crear_equipo">
    ...
    <table class="table">
        ...
        <?php foreach($proyectos['proyectos'] as $proyecto):
            ...
            ?>
            <tr>
                <td><span class="popover1" data-type='html' style="cursor: pointer"  data-title="Título de proyecto" data-content="<?= str_replace('"','\'',$proyecto['titulo']) ?>" data-placement="top"><?= substr($proyecto['titulo'],0,14) ?> </span></td>
